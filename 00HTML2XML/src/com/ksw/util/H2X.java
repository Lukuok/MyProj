...
public class H2X 
{
    ...
    public HashMap<String, Integer>      namedentities = new HashMap<String, Integer>();
    public List<String>                  emptytags     = new ArrayList<String>();
    public HashMap<String, List<String>> autoclosetags = new HashMap<String, List<String>>();
    String resultString;

    public H2X(String htmlText)
    {
        resultString = html2Xml(htmlText);
    }
    ...
    public String html2Xml(String s)
    {
